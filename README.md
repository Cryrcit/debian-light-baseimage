# cryrcit/light-baseimage

[![Docker Pulls](https://img.shields.io/docker/pulls/cryrcit/light-baseimage.svg)][hub]
[![Docker Stars](https://img.shields.io/docker/stars/cryrcit/light-baseimage.svg)][hub]
[![](https://images.microbadger.com/badges/image/cryrcit/light-baseimage.svg)](http://microbadger.com/images/cryrcit/light-baseimage "Get your own image badge on microbadger.com")

[hub]: https://hub.docker.com/cryrcit/light-baseimage/

Latest release: 1.0 [Changelog](CHANGELOG.md)
 | [Docker Hub](https://hub.docker.com/cryrcit/light-baseimage/) 
...
Table of Contents
- [cryrcit/light-baseimage](#cryrcitlight-baseimage)
...
In the Dockerfile we are going to:
  ...
  - Define ports exposed and volumes if needed.
        ...
        # Use cryrcit/light-baseimage
        # https://github.com/cryrcit/light-baseimage
        FROM cryrcit/light-baseimage:1.0
        ...
        # https://github.com/cryrcit/light-baseimage/blob/stable/image/tool/install-service
...
In the Dockerfile we are going to:
  ...
  - Define ports exposed and volumes if needed.
        ...
        # https://github.com/cryrcit/docker-light-baseimage/blob/stable/image/tool/add-multiple-process-stack
        RUN apt-get -y update \
        ...
        # Use baseimage install-service script
        # https://github.com/cryrcit/docker-light-baseimage/blob/stable/image/tool/install-service
        RUN /container/tool/install-service
...
Here simple Dockerfile example how to add a service-available to an image:
        ...
        # https://github.com/cryrcit/docker-light-baseimage/blob/stable/image/tool/add-service-available
        # https://github.com/cryrcit/docker-light-baseimage/blob/stable/image/service-available/:ssl-tools/download.sh
        # https://github.com/cryrcit/docker-light-baseimage/blob/stable/image/service-available/:cron/download.sh
        RUN apt-get -y update \
...
*Run tool* takes several options, to list them:
    ...
    docker run cryrcit/light-baseimage:1.0 --help
    ...
    cryrcit! Light Baseimage: https://github.com/cryrcit/docker-light-baseimage
...
Example:
    ...
    docker run -it cryrcit/light-baseimage:1.0
...
Can also be set by command line converted in python or json:
    ...
    docker run -it --env FRUITS="#PYTHON2BASH:['orange','apple']" cryrcit/light-baseimage:1.0 printenv
    docker run -it --env FRUITS="#JSON2BASH:[\"orange\",\"apple\"]" cryrcit/light-baseimage:1.0 printenv
